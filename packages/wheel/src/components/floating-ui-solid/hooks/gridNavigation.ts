...
/**
 * Solid port of upstream's `gridNavigation.ts`.
 *
 ...
 *
 * `listRef` follows the locked convention: a plain `{ current: Array<HTMLElement | null> }`
 * mutable container rather than a React ref object.
 */
