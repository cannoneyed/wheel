...
- Unit tests cover the required label, hidden icon, square identity, variants, sizes, loading, actions, links, and Button Group inheritance.
- Browser tests cover keyboard activation and grouped roving focus.
- Catalog fixtures show all variants, all sizes, disabled, loading, grouped, and linked examples.
