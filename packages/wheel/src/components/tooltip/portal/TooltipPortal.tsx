 ...
 * without the tabbable/focus-guard machinery, since tooltips aren't modal). This calls
 * `useFloatingPortalNode` directly instead — the Solid port of that same underlying primitive —
 * rather than introducing a `FloatingPortalLite` wrapper with no other current caller.
 */
export function TooltipPortal(componentProps: TooltipPortal.Props): JSX.Element {
