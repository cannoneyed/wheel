...
/**
 * Item-value equality helpers shared by `Select`'s value/selection resolution.
 * Solid port of upstream's `internals/itemEquality.ts` — framework-neutral, ported unchanged.
 */
