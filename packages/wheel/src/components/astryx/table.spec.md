# Table behavior specification

- Presents dense tabular data with interactive state.
- Astryx family coverage: `Table`, `TableBody`, `TableCell`, `TableFooter`, `TableHeader`, `TableHeaderCell`, `TableRow`; compact/balanced/spacious
- Wheel family contract: Add composed and data-driven modes. Cover sorting, filtering, pagination, selection, expansion, grouping, tree rows, sticky and resizable columns, virtualization, status, keyboard use, and empty/loading/error states.
