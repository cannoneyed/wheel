# TimeInput behavior specification

- Edits a locale-aware time through stable segments.
- Astryx family coverage: `TimeInput`; sizes `sm`–`lg`; success, warning, error
- Wheel family contract: Add locale-aware segmented input, 12/24-hour display, seconds, bounds, step, clear, and keyboard behavior.
