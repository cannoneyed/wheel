# FileInput behavior specification

- Selects or drops files and reports validation or upload state.
- Astryx family coverage: `FileInput`; input/dropzone; success, warning, error
- Wheel family contract: Add native selection, drag and drop, multiple files, accept rules, size limits, progress, retry, remove, and invalid-file behavior.
