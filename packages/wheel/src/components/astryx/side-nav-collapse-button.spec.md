# SideNavCollapseButton behavior specification

- Collapses and restores Side Nav without losing destinations.
- Astryx family coverage: `MobileNav`, `MobileNavToggle`; `NavHeadingMenu`, `NavIcon`; `SideNav`, `SideNavCollapseButton`, `SideNavHeading`, `SideNavItem`, `SideNavSection`; `TopNav`, `TopNavHeading`, `TopNavItem`, `TopNavMenu`, `TopNavMegaMenu`, `TopNavMegaMenuItem`, `TopNavMegaMenuFeaturedCard`
- Wheel family contract: Add Mobile Nav, Side Nav, and Top Nav families. Keep Wheel Navigation Menu for rich popup navigation and share item, icon, and overflow rules.
