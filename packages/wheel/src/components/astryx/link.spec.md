# Link behavior specification

- Navigates to an internal, external, or downloaded resource.
- Astryx family coverage: `Link`
- Wheel family contract: Add external, router, download, disabled, inline, standalone, and visited behavior. Integrate with Wheel Router through a provider.
