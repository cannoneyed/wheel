# DialogHeader behavior specification

- Aligns a dialog title, description, close action, and tools.
- Astryx family coverage: `Dialog`, `DialogHeader`, `AlertDialog`; standard and fullscreen
- Wheel family contract: Extend Wheel Dialog and Alert Dialog. Add standalone Dialog Header for consistent title, subtitle, close, and action layout.
