# Spinner behavior specification

- Reports an indeterminate wait after an optional delay.
- Astryx family coverage: `Spinner`; sizes `sm`–`lg`
- Wheel family contract: Add an indeterminate activity indicator with delayed display, accessible labeling, inline and overlay use, and reduced motion.
