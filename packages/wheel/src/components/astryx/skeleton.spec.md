...
- Reserves content geometry while data is unavailable.
- Astryx family coverage: `Skeleton`
- Wheel family contract: Add text, circle, rectangle, multi-line, and custom-size placeholders. Do not use entry animation; respect reduced motion.
