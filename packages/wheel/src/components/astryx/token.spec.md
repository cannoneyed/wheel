...
- Represents one compact value with optional remove action.
- Astryx family coverage: `Token`; sizes `sm`–`lg`; default plus 10 colors
- Wheel family contract: Add text, icon, avatar, remove, selected, disabled, overflow, and keyboard behavior.
