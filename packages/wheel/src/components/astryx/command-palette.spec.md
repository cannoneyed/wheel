# CommandPalette behavior specification

- Searches and runs grouped application commands.
- Astryx family coverage: `CommandPalette`, `CommandPaletteInput`, `CommandPaletteList`, `CommandPaletteGroup`, `CommandPaletteItem`, `CommandPaletteEmpty`, `CommandPaletteFooter`
- Wheel family contract: Add a composed command palette with modal and embedded modes, async search, grouping, rich rows, picker mode, hotkeys, and focus restoration.
