# SegmentedControl behavior specification

- Selects one value from a compact visible set.
- Astryx family coverage: `SegmentedControl`, `SegmentedControlItem`; sizes `sm`–`lg`; hug/fill
- Wheel family contract: Add a semantic single-select control. Reuse Toggle Group focus logic, but keep separate radio semantics and visual contract.
