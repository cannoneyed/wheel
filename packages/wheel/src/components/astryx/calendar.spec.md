...
- Selects one date or a bounded date range.
- Astryx family coverage: `Calendar`; single and range modes
- Wheel family contract: Add a locale-aware calendar with keyboard grid navigation, disabled dates, min/max bounds, month and year changes, and right-to-left behavior.
