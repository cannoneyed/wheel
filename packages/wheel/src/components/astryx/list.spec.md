# List behavior specification

- Orders semantic or interactive items with shared density.
- Astryx family coverage: `List`, `ListItem`; compact/balanced/spacious
- Wheel family contract: Add semantic and interactive list modes, headers, dividers, rich items, selection, actions, loading, empty, and virtualized behavior.
