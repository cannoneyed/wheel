# ResizeHandle behavior specification

- Changes a panel size with pointer or keyboard input.
- Astryx family coverage: `ResizeHandle`; horizontal/vertical
- Wheel family contract: Add a Resizable family with controlled and uncontrolled size, min/max, collapse, snap, keyboard, persistence, and nested panel behavior.
