# PowerSearch behavior specification

- Searches across scopes, filters, commands, and recent items.
- Astryx family coverage: `PowerSearch`; sizes `sm`–`lg`; success, warning, error
- Wheel family contract: Add a search composition for scopes, filters, tokens, async results, recent searches, commands, and clear behavior. Reuse Combobox and Token.
