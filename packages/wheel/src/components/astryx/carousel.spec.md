...
- Moves through an ordered set of media or content panels.
- Astryx family coverage: `Carousel`
- Wheel family contract: Add composed viewport, track, slide, controls, indicators, drag, autoplay policy, reduced motion, and live announcements.
