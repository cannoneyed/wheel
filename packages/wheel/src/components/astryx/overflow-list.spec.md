# OverflowList behavior specification

- Keeps ordered items visible until space requires an overflow menu.
- Astryx family coverage: `OverflowList`
- Wheel family contract: Add measurement, stable visible order, overflow count, custom overflow trigger, resize updates, and server-render fallback.
