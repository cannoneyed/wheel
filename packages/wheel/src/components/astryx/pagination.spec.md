# Pagination behavior specification

- Moves through known or unknown result pages.
- Astryx family coverage: `Pagination`; pages, count, compact, dots, input, none; sizes `sm`, `md`
- Wheel family contract: Add controlled pagination with unknown totals, first/last, page-size, loading, disabled, URL, and responsive behavior.
