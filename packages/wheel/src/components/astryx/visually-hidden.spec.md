# VisuallyHidden behavior specification

- Keeps content available to assistive technology without visual layout.
- Astryx family coverage: `VisuallyHidden`
- Wheel family contract: Add visually hidden content with focusable skip-link mode, forced-color support, and no layout effect.
