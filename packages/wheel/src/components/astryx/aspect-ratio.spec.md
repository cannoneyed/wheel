# AspectRatio behavior specification

- Keeps media at a stable ratio while its container resizes.
- Astryx family coverage: `AspectRatio`; `rectangle`, `ellipse`
- Wheel family contract: Add a media wrapper with ratio, shape, fallback, loading, and object-fit behavior.
