# Blockquote behavior specification

- Presents quoted content with an optional source.
- Astryx family coverage: `Blockquote`
- Wheel family contract: Add quote, citation, and attribution slots with semantic markup.
