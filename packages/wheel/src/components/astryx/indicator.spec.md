# Indicator behavior specification

- Shows checked, mixed, selected, or current state.
- Astryx family coverage: `CheckboxIndicator`; unchecked/checked/indeterminate. `CheckIndicator` and `RadioIndicator`; unchecked/checked. Sizes `sm`, `md`
- Wheel family contract: Add one shared Indicator family. Reuse it through Checkbox, Radio, Select, and Menu without coupling their state.
