# BottomSheetSwitcher behavior specification

- Switches between related Bottom Sheet surfaces without losing context.
- Astryx family coverage: `BottomSheet`, `BottomSheetSwitcher`; snap points, drag, scrim, keyboard, and sheet handoff patterns
- Wheel family contract: Add a mobile Bottom Sheet. Reuse Drawer mechanics where they match, but keep sheet sizing and switcher behavior separate. Entry stays immediate.
