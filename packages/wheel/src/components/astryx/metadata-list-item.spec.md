# MetadataListItem behavior specification

- Pairs one metadata label with its value.
- Astryx family coverage: `MetadataList`, `MetadataListItem`; vertical/horizontal
- Wheel family contract: Add label/value rows, column layout, collapse, copy, links, empty values, and responsive orientation.
