# TreeList behavior specification

- Navigates hierarchical rows with disclosure and selection.
- Astryx family coverage: `TreeList`
- Wheel family contract: Add disclosure, selection, focus, lazy children, drag, rename, actions, virtualization, and right-to-left keyboard behavior.
