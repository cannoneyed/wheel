# StatusDot behavior specification

- Pairs a compact color mark with a named status.
- Astryx family coverage: `StatusDot`; success, warning, error, accent, neutral
- Wheel family contract: Add a compact status mark that never relies on color alone. Define optional label and pulse policy.
