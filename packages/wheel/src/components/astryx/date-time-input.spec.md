# DateTimeInput behavior specification

- Edits a date and time without losing locale semantics.
- Astryx family coverage: `DateInput`, `DateRangeInput`, `DateTimeInput`; sizes `sm`–`lg`; success, warning, error
- Wheel family contract: Add three locale-aware inputs. Share Calendar and Time Input parts. Define parsing, formatting, segments, clear, bounds, and mobile behavior.
