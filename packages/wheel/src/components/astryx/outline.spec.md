# Outline behavior specification

- Tracks headings and moves within a long page.
- Astryx family coverage: `Outline`
- Wheel family contract: Add an in-page outline with heading tracking, nesting, active section, collapse, keyboard use, and scroll offset.
