# Stepper behavior specification

- Shows progress and navigation across ordered task steps.
- Astryx family coverage: `Stepper`, `Step`; compact/balanced/spacious; accent, success, warning, error
- Wheel family contract: Add progress and navigation modes, linear and non-linear steps, optional steps, errors, overflow, responsive layout, and announcements.
