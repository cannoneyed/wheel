# EmptyState behavior specification

- Explains an empty result and offers the next useful action.
- Astryx family coverage: `EmptyState`
- Wheel family contract: Add title, description, media, primary action, secondary action, container, and compact variants.
