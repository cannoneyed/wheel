...
- Provides shared modal and non-modal layer structure.
- Astryx family coverage: `Overlay`
- Wheel family contract: Add a shared composed overlay surface for modal and non-modal content, layer ownership, scroll lock, dismissal, and exit-only motion.
