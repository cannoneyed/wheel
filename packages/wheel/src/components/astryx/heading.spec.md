# Heading behavior specification

- Applies heading type while preserving the chosen heading level.
- Astryx family coverage: `Text`; body, large, label, supporting, code, display levels, inherit; size and color scales. `Heading`; display levels and semantic colors
- Wheel family contract: Add Text and Heading as separate public entries. Keep HTML semantics separate from visual type.
