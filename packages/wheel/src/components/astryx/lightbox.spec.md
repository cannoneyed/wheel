# Lightbox behavior specification

- Views media with captions, gallery navigation, zoom, and pan.
- Astryx family coverage: `Lightbox`
- Wheel family contract: Add image and media viewing, gallery navigation, zoom, pan, captions, preload, focus trap, escape, and history policy.
