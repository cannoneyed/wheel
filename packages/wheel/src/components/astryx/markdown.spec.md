...
- Renders sanitized Markdown through Wheel components.
- Astryx family coverage: `Markdown`; default and compact density
- Wheel family contract: Add safe rendering, component overrides, code, tables, links, task lists, streaming updates, and copy behavior. Sanitization is required.
