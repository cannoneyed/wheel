# Thumbnail behavior specification

- Previews an image, video, or file with fallback and status.
- Astryx family coverage: `Thumbnail`
- Wheel family contract: Add image, video, file, fallback, status, selection, aspect ratio, loading, and error behavior.
