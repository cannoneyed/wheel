# AppShell behavior specification

- Frames application navigation, content, and supporting panels.
- Astryx family coverage: `AppShell`; surface `wash`, `surface`, `section`, `elevated`
- Wheel family contract: Add a slot-based application shell. Keep domain layout state in Wheel’s `LayoutService`; keep this component presentational.
