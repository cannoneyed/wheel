# Tokenizer behavior specification

- Creates and edits a validated collection of Tokens.
- Astryx family coverage: `Tokenizer`; sizes `sm`–`lg`; success, warning, error
- Wheel family contract: Add multi-value entry with suggestions, paste parsing, duplicates, validation, reorder, limits, and keyboard removal. Reuse Combobox and Token.
