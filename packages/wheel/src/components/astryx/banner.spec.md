# Banner behavior specification

- Presents a page or section message with optional actions.
- Astryx family coverage: `Banner`; info, warning, error, success
- Wheel family contract: Add inline, floating, section, dismissible, collapsible, and action variants.
