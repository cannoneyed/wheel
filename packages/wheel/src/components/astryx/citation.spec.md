# Citation behavior specification

- Links an inline source marker to its full reference.
- Astryx family coverage: `Citation`; label and number variants
- Wheel family contract: Add an inline citation trigger and a source-list relationship. Define focus, hover, print, and screen-reader behavior.
