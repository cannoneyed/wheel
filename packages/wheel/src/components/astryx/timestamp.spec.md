# Timestamp behavior specification

- Displays absolute or relative time with machine-readable output.
- Astryx family coverage: `Timestamp`; semantic text types, size scale, and color scale
- Wheel family contract: Add absolute and relative display, locale, time zone, refresh policy, machine-readable output, and tooltip detail.
