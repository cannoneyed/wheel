# Item behavior specification

- Composes a dense row from media, text, status, and actions.
- Astryx family coverage: `Item`
- Wheel family contract: Add a dense row primitive with label, description, media, actions, selection, disabled state, and link/button semantics.
