# TextArea behavior specification

- Edits multi-line text with fixed or content-driven height.
- Astryx family coverage: `TextArea`; sizes `sm`–`lg`; success, warning, error
- Wheel family contract: Add fixed and auto-grow modes, character count, resize policy, clear, read-only, loading, and validation.
