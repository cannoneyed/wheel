# Kbd behavior specification

- Displays one key, chord, or key sequence.
- Astryx family coverage: `Kbd`
- Wheel family contract: Add single key, chord, and sequence display with semantic `<kbd>` markup.
