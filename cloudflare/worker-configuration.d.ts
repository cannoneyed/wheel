/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.test.jsonc cloudflare/worker-configuration.d.ts` (hash: f564eefdb7e16c5c6e6f3b1fc8fde37f)
// Runtime types generated with workerd@1.20260820.1 2026-08-21 
interface __BaseEnv_Env {
	TRACKER_WORKSPACES: DurableObjectNamespace<import("./test-worker").TrackerWorkspace>;
	BACKEND_HARNESS: DurableObjectNamespace<import("./test-worker").BackendHarnessWorkspace>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./test-worker");
		durableNamespaces: "TrackerWorkspace" | "BackendHarnessWorkspace";
	}
