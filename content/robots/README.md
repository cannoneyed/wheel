...
- [Production](production.md) - static assets, Worker routing, Durable Objects, base paths, and observability.
...
2. `content/docs/*.mdx` explains the human workflow. `content/robots/*.md` carries operational detail.
3. `content/robots/api/*.md` is generated by `bun run docs:robots`.
